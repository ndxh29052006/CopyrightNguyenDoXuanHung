...
module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "BuiChiThong",
    description: "Kiểm tra lượt tương tác trong nhóm ( Thông Fix Lại )",
...
module.exports.languages = {
    "vi": {
        "tatca": "%1/ %2 với %3 tin nhắn trong nhóm\n",
        "mention": "%1 đứng hạng %2 đang có %3 tin nhắn trong nhóm",
        "myself": "${namevictim} đang có %2 tin nhắn trong nhóm"
    },
    "en": {
...
module.exports.run = async function ({ args, api, event, Currencies, getText }) {
    ...
    try {
        ...
        if (args[0] == "all") {
            ...
            page < -1 ? page = 1 : "";
            var limit = 10;
            var msg = "Số Tin Nhắn Của Các Thành Viên Trong Nhóm Là:\n";
            ...
            msg += `--Trang ${page}/${numPage}--\nDùng ${global.config.PREFIX}để xem tất cả số trang`
